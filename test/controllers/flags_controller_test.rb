...
class FlagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flag" do
    assert_difference('Flag.count') do
      post flags_url, params: { flag: { description: @flag.description, name: @flag.name, user_id: @flag.user_id } }
    end
  ...
  test "should update flag" do
    patch flag_url(@flag), params: { flag: { description: @flag.description, name: @flag.name, user_id: @flag.user_id } }
